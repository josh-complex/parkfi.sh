...
export function ErrorTestPanel() {
  ...
  if (!open) {
    return (
      <button
        ...
        className="pointer-events-auto fixed left-3 bottom-[calc(var(--bottom-nav-height,0px)+env(safe-area-inset-bottom)+1rem)] z-[80] inline-flex size-9 items-center justify-center rounded-full bg-black/60 text-white shadow-lg ring-1 ring-white/20 transition active:scale-95 md:bottom-4"
      >
  ...
  return (
    <div className="pointer-events-auto fixed left-3 bottom-[calc(var(--bottom-nav-height,0px)+env(safe-area-inset-bottom)+1rem)] z-[80] w-64 overflow-hidden rounded-2xl bg-black/85 text-white shadow-xl ring-1 ring-white/20 backdrop-blur md:bottom-4">
