...
| `world`       | system     | narrative beacon driven by the live feed — the ride-down "Dimming," the crowd "surge" | how the park _speaks_        |
...
| `encounter`   | system     | a spawned Faded battle (see [04](04-game-design.md))                                  | the game core                |
...
- **Create:** standing at a real spot (verified), a Warden drops a `discovery`
  ...
  you aren't at.
- **Find:** other Wardens within the geofence get a wrist/ear cue and can reveal
...
The "other players" a Warden feels are mostly **people who already left**. That
