...
import { PlusIcon, RefreshCwIcon, ShieldCheckIcon, KeyRoundIcon, TrashIcon } from "lucide-react";
import { useQuery, useQueryClient } from "@tanstack/react-query";
import { authClient } from "#/lib/auth-client.ts";
import { passkeysQueryOptions } from "#/lib/auth-queries.ts";
...
export const Route = createFileRoute("/_dash/account/security")({
