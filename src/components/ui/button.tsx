...
const buttonVariants = cva(
  "group/button relative top-0 inline-flex shrink-0 items-center justify-center rounded-4xl border-3d shadow-3d text-sm font-medium whitespace-nowrap outline-none select-none transition-[box-shadow,top,background-color,border-color,color] duration-150 ease-out hover:-top-px hover:shadow-3d-hover focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/30 active:not-aria-[haspopup]:top-[3px] active:not-aria-[haspopup]:[--btn-glare:var(--btn-3d)] active:not-aria-[haspopup]:shadow-3d-active disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
