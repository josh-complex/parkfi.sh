          ...
          {open && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
              ...
              <motion.div
                ...
                className="relative z-10 flex max-h-full w-full max-w-4xl flex-col overflow-hidden bg-popover border-3d btn-3d-outline shadow-[0_4px_0_0_var(--btn-3d),inset_0_1px_0_0_var(--btn-glare)] dark:border-[color-mix(in_oklch,var(--border),white_25%)] dark:ring-1 dark:ring-foreground/10"
              >
