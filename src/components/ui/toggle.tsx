...
const toggleVariants = cva(
  "group/toggle relative top-0 inline-flex items-center justify-center gap-1 rounded-3xl border-3d shadow-3d text-sm font-medium whitespace-nowrap outline-none select-none transition-[box-shadow,top,background-color,border-color,color] duration-150 ease-out hover:-top-px hover:shadow-3d-hover focus-visible:z-10 focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/30 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none aria-invalid:border-destructive aria-invalid:ring-destructive/20 aria-pressed:top-[3px] aria-pressed:z-10 aria-pressed:[--btn-glare:var(--btn-3d)] aria-pressed:shadow-3d-active dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
