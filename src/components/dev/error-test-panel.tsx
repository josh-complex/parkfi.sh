...
export function ErrorTestPanel() {
  ...
  return (
    <div className="pointer-events-auto fixed left-(--chrome-gutter) bottom-[calc(var(--bottom-nav-height,4.5rem)+var(--safe-bottom)+1.4rem)] z-80 w-64 overflow-hidden rounded-2xl bg-black/85 text-white shadow-xl ring-1 ring-white/20 backdrop-blur md:bottom-4">
