  ...
  return (
    <>
      <PageMasthead
        ...
        title="Disclaimers & Legal Notice"
        description="ParkFi is an independent, unofficial tool. Here is everything that means — for the parks' trademarks, for our data, and for you."
      />
      <PageBody size="prose">
        <LegalSection title="Independent Third-Party Tool">
          <p>
            ...
            or in any way officially connected to The Walt Disney Company, Disney Parks, Experiences
            and Products, Universal City Studios LLC, Universal Parks &amp; Resorts, Comcast
            Corporation, NBCUniversal, or any of their respective subsidiaries, affiliates,
            licensors, or related entities (collectively, &ldquo;the Parks&rdquo;).
          </p>
        </LegalSection>

        <LegalSection title="Trademark Notice">
          <p>
          ...
          <p>
            ...
            references constitute nominative fair use and do not imply any sponsorship, affiliation,
            or endorsement.
          </p>
        </LegalSection>

        <LegalSection title="Data Sources &amp; Accuracy">
          <p>
            ...
            publicly available sources and unofficial APIs. It is collected by automated systems on
            a periodic basis and is presented &ldquo;as is.&rdquo; This data:
          </p>
        ...
        <LegalSection title="Wait Times &amp; Ride Status">
          <p>
            Posted wait times, ride operating status, and downtime information are estimates derived
            from third-party data and may not reflect actual conditions at the parks. Attractions
            may open, close, or experience unexpected downtime at any time, and posted standby waits
            frequently differ from real-world queue times. Nothing on parkfi.sh should be treated as
            a guarantee that any attraction will be operating or available during your visit.
          </p>
        </LegalSection>

        <LegalSection title="Maps, Navigation &amp; Walking Directions">
          <p>
            The interactive map and walking-directions features are provided as a planning
            convenience only. Routes, distances, and estimated walking times are computed by our own
            routing engine from{" "}
            <a
        ...
        <LegalSection title="Crowd Forecasts &amp; Wait-Time Predictions">
          <p>
            Crowd calendars, crowd-level scores, predicted wait-time curves, and any figures labeled
            as forecasts or predictions are <strong>statistical estimates</strong> produced by
            models trained on historical data. Ranges and confidence bands describe the
            model&rsquo;s uncertainty — they are not promises about what will happen. Forecasts can
            be materially wrong, particularly around holidays, special events, weather disruptions,
            new attraction openings, and anything else history does not predict well. Where we show
            accuracy statistics, they describe past performance only. Do not make plans that depend
            on a forecast being right.
          </p>
        </LegalSection>

        <LegalSection title="Ticket Pricing">
          <p>
          ...
          <p>
            ...
            best-effort data and is not a price quote, offer, or recommendation. Always confirm the
            final price on the official park website or with an authorized ticket seller before
            purchasing.
          </p>
        </LegalSection>

        <LegalSection title="Dining Reservations &amp; Availability">
          <p>
        ...
        <LegalSection title="Resort &amp; Stay Availability">
          <p>
            ...
            eligibility restrictions, and may differ materially from the rates and availability
            shown at the time of booking.
          </p>
          <p>
            parkfi.sh <strong>does not sell, reserve, or broker lodging</strong> of any kind, is not
            a travel agency, and has no relationship with Disney Vacation Club or any resort
        ...
        <LegalSection title="Accounts, Alerts &amp; Notifications">
          <p>
        ...
        <LegalSection title="No Commercial Relationship">
          <p>
        ...
        <LegalSection title="Limitation of Liability">
          <p>
            ...
            or exemplary damages arising from your use of, or reliance on, any information, feature,
            or alert provided by this site — including but not limited to missed attractions, missed
            or lost dining reservations, unavailable or mispriced tickets, unavailable or mispriced
            resort rooms, delayed or undelivered notifications, and any travel, lodging, or
            financial decisions made in reliance on the foregoing.
          </p>
        </LegalSection>
        ...
        <LegalSection title="Contact &amp; Takedown Requests">
          <p>
            ...
            contact us and we will respond promptly. We are happy to work cooperatively to address
            any legitimate concerns — we built this for fellow park fans and have no interest in
            causing harm to the parks or their operators.
          </p>
        </LegalSection>
        ...
        <section className="flex flex-col gap-3 rounded-xl border border-dashed bg-muted/30 p-5">
          ...
          <div className="text-sm text-muted-foreground leading-relaxed flex flex-col gap-2">
            <p>
              ...
              are completely, hopelessly enchanted by them — by the engineering, the storytelling,
              the logistics of moving a small city&rsquo;s worth of delighted people through a day,
              and the fact that someone, somewhere, sweats the paint on a trash can so a
              six-year-old gasps in the right spot.
            </p>
            <p>
              ...
              are the kind of obsessive who reads the queue-theory paper for fun and then ships the
        ...
        <p className="text-xs text-muted-foreground border-t pt-4">
          ...
          advice. parkfi.sh is a personal project and is not a legal entity. By using this site you
